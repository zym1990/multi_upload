		...
		**/	
		_loadAjaxFile: function(awidget, file, loader){
			...
			awidget.find('.powerwidget-ajax-placeholder').load(file, function(response, status, xhr){
				...
				**/
				if(status == "error"){
				  $(this).html('<div class="inner-padding">'+self.o.labelError + '<b>'+xhr.status + " " + xhr.statusText+'</b></div>');
				}
				...
				if(!thisHeader.parent().attr('role')){
					...
					**/
					if(self.o.customButton === true && tWidget.data('widget-custombutton') === undefined && self.customClass[0].length != 0){	
						var customBtn = '<a href="#" class="button-icon powerwidget-custom-btn"><i class="'+self.customClass[0]+'"></i></a>';
					}else{
							customBtn = '';
					}
		...
		**/
		_clickEvents: function(){
			...
			//*****************************************************************//
				...
				**/
				self.widget.on(clickEvent,'.powerwidget-fullscreen-btn', function(e){
			...
			//*****************************************************************//
				...
				**/
				self.widget.on(clickEvent,'.powerwidget-edit-btn', function(e){
			...
			//*****************************************************************//
				...
				* Allow users to show/hide a edit box.
				**/
				self.widget.on(clickEvent,'.powerwidget-custom-btn', function(e){
			...
			//*****************************************************************//
				...
				**/
				self.widget.on(clickEvent,'.powerwidget-delete-btn', function(e){
			...
			//******************************************************************//
				...
				**/
				self.widget.on(clickEvent, '.powerwidget-refresh-btn', function(e){
